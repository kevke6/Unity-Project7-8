...
half4 fragForwardBase (VertexOutputForwardBase i) : SV_Target
{
	...
	float3 posWorld = i.fogCoord.xyz;
	...
	UNITY_APPLY_FOG(i.fogCoord.w, c.rgb);
...
half4 fragForwardAdd (VertexOutputForwardAdd i) : SV_Target
{
	...
	UNITY_APPLY_FOG_COLOR(i.fogCoord.w, c.rgb, half4(0,0,0,0)); // fog towards black in additive pass
