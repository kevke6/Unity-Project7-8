...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, posWorld).xyz; TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, posWorld); TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, posWorld).xy; TRANSFER_SHADOW(a)
